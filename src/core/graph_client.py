...
class GraphClient:
    ...
    async def request(self, method: str, endpoint: str, headers: Optional[Dict] = None, **kwargs) -> Any:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                raise GraphAPIException(status_code=500, message=f"Network error: {e}")
    ...
    async def put(self, endpoint: str, data: Any = None, content_type: str = "application/json") -> Any:
